...
type
  ...
  TThoriumInstructionAPPEND = record
    Instruction: TThoriumInstructionCode;
    SRI: Word;
    TRI: Word;
    Reserved: array [0..9] of Word;
...
const
  ...
  THORIUM_OPERATION_NAMES : array [TThoriumOperation] of String = (
    'assignment',
    'in-place increment',
    'in-place decrement',
    'test for equality',
    'test for inequality',
    'test for greater',
    'test for greater or equality',
    'test for less',
    'test for less or equality',
    'addition',
    'subtraction',
    'multiplication',
    'division',
    ...
    'clone',
    'append to',
    'create from values on stack',
    'convert to native data',
    'convert from native data',
    'free native data'
  );
{%ENDREGION}
